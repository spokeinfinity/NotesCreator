...
public class EditBookActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_EDIT_BOOK_TITLE = "pl.edu.pb.wi.EDIT_BOOK_TITLE";
    public static final String EXTRA_EDIT_BOOK_AUTHOR = "pl.edu.pb.wi.EDIT_BOOK_AUTHOR";
